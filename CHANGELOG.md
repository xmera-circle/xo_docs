# Changelog for xmera Omnia Documentation
...
* further dashboard blocks (counter, version, key ratio)
* query category screenshots and explanaitions
* periodic task copy feature
* issue conversion to periodic task

## 1.7.0 - 2025-10-10

### Added

* wiki metadata feature
* support for xmera Omnia 5

### Changed

* wording: 'Stapel' -> 'Liste' w.r.t. 'Aufgaben'
* ui theme to version 1.0.2

## 1.6.0 - 2025-01-12

### Added

* further calculation methods for own fields
* email validation code as alternative second factor method
* integration drawio UI as user preference
* single view of periodic tasks
